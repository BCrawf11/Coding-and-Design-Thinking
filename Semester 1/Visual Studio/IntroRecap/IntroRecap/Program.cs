...
namespace IntroRecap
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (isAlsoValid = true)
            {
                Console.WriteLine("isAlsoValid is true");
            }
            //else if isValid is not true, then console writeline "isValid is not true"
            else
                Console.WriteLine("isAlsoValid is not true");
            ...
            string[] intArray = new string[3] { "buddy", "guy", "friend" };
